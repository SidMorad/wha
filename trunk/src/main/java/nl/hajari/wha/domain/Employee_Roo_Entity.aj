...
privileged aspect Employee_Roo_Entity {
    ...
    public static EntityManager Employee.entityManager() {    
    ...
    public static Employee Employee.findEmployee(Long id) {    
        if (id == null) throw new IllegalArgumentException("An identifier is required to retrieve an instance of Employee");        
